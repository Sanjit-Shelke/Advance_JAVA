...
<body style="background-image: url(visa_login.jpg); background-size: cover">
	...
	<spr:form action="visa_update.htm" method="post" commandName="visa" >
                ...
                <div class="row justify-content-center" style="height:50vh;">
                    <div class="col-12 ">
                        ...
                        <div class="row bg-success" style="height:10vh;border-style: outset;">
                            <div class="col-12 " style="color:black;font-size: 35px; font-family: inherit; padding-left: 40px">Update Visa Details</div>
                        </div>
